package com.alkemy.wallet.security.util;
...
public class JwTUtil {
    ...
    private final static String SECRET_KEY="SecretLumina";
    ...
    private Claims extractAllClaims(String token) {
        return Jwts.parser().setSigningKey(SECRET_KEY.getBytes(Charset.forName("UTF-8")))
